...
<title>Prescription for Headache</title>
<style>
#ab{color:green;}
#a{
...
-----------------------------------------------------------------------------------------------
<img src="Rx.png" alt="Na" height="15px"></img>:Prescription for Headache,
...
-----------------------------------------------------------------------------------------------
 Suggestions:
 1.Avoid watching television and using mobiles at high brightness.
 2.Don't think about the works and stay calm.
 3.Follow the prescription carefully and take the medicine at regular intervals.
 4.Give rest for your brain.
 NOTE:
 ...
 need not to be verified.         
		...
		window.location="Headache.html"</script><%
		}
}
