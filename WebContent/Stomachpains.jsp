...
<title>Prescription for Stomachpains</title>
<style>
#ab{color:green;}
#a{
...
-----------------------------------------------------------------------------------------------
<img src="Rx.png" alt="Na" height="15px"></img>:Prescription for Stomach pain,

          Medicine name                  |   Type    |   Morning    |    Noon    |  Evening |<br>
          Meftal-SPAZ                    |   Tab     |      1       |      -     |      1   |<br>
          Ampilicin                      |   Inj     |      1       |      -     |      -   |<br>
...
-----------------------------------------------------------------------------------------------
 Suggestions:
 1.Take light food and never take fastfood.
 ...
 need not to be verified.         
		...
		window.location="Stomachpains.html"</script><%
		}
}
