...
<title>Prescription for Gastric</title>
<style>
#ab{color:green;}
#a{
...
-----------------------------------------------------------------------------------------------
<img src="Rx.png" alt="Na" height="15px"></img>:Prescription for Gastric,

          Medicine name                  |   Type    |   Morning    |    Noon    |  Evening  |<br>
          Rantac                         |   Tab     |      1       |      -     |     1     |<br>
          Gelisul-MPS                    |   Syr     |      1(cap)  |      1(cap)|     1(cap)|<br>
...
-----------------------------------------------------------------------------------------------
 Suggestions:
 1.Take light food and avoid heavy food,junk foods are strictly avoided.
 ...
 need not to be verified.         
		...
		window.location="Gastric.html"</script><%
		}
}
