...
<b  title="VIEW ORDERS"><a href="ViewOrders.html">View Orders</a></b><br>
...
try
{
	...
	ResultSet rs=st.executeQuery("select * from quer");
%>
<div id="section">
<h2>The existing feedbacks are as follows..<br><br>
<table align="left" border="2">
<th>Username</th><th>Query</th><tr>
<%
while(rs.next())
{
%>
<td><%out.print(rs.getString(1)); %>
<td><%out.print(rs.getString(2)); %><tr>
</tr>
<%
}
%>
