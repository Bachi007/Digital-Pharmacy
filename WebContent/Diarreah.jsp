...
<title>Prescription for Diarreah/Motions</title>
<style>
#ab{color:green;}
#a{
...
-----------------------------------------------------------------------------------------------
<img src="Rx.png" alt="Na" height="15px"></img>:Prescription for Diarreah,

          Medicine name                  |   Type    |   Morning    |    Noon    |  Evening  |<br>
          Cremaffin                      |   Syr     |      1(cap)  |      1(cap)|     1(cap)|<br>
          Eldoper                        |   Tab     |      1       |      -     |     -     |<br>
          ORS-Drink                      |   Dri     |      1       |      -     |     1     |<br>
...
-----------------------------------------------------------------------------------------------
 Suggestions:
 1.Take light food and intake  fluids,
 2.Regularly consume the fluids/energy drinks,
 3.Its advisibleto take rehydration salts regularly,
 ...
 need not to be verified.         
		...
		window.location="Diarreah.html"</script><%
		}
}
